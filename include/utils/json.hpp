...
public:
	...
	inline bool isNull() 	{return val.index() == null_t;		}
	inline bool isObject()  {return val.index() == object_t;	}
	inline bool isArray() 	{return val.index() == array_t;		}
	inline bool isString()  {return val.index() == string_t;	}
	inline bool isBool() 	{return val.index() == boolean_t;	}
	inline bool isNumber()  {return val.index() == number_t;	}
...
public:
	// parse a tokenstream
	//	+ can parse without soring the entire source
